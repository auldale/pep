...
namespace pep {
     ...
     * Base class for handlers based on a DOMPropertySet.
     */
    class AbstractHandler : public virtual Handler, public DOMPropertySet
    {
    protected:
        /**
         * Constructor
        ...
        void log(PEPRequest::SPLogLevel level, const std::string& msg) const;
...
/*        virtual long sendPostResponse(
         ...
         */
        std::pair<bool,bool> getBool(const char* name, const PEPRequest& request, unsigned int type=HANDLER_PROPERTY_ALL) const;
         ...
         * @return a pair consisting of a nullptr indicator and the property value iff the indicator is true
         */
        std::pair<bool,const char*> getString(const char* name, const PEPRequest& request, unsigned int type=HANDLER_PROPERTY_ALL) const;
         ...
         * @return a pair consisting of a nullptr indicator and the property value iff the indicator is true
         */
        std::pair<bool,unsigned int> getUnsignedInt(const char* name, const PEPRequest& request, unsigned int type=HANDLER_PROPERTY_ALL) const;
         ...
         * @return a pair consisting of a nullptr indicator and the property value iff the indicator is true
         */
        std::pair<bool,int> getInt(const char* name, const PEPRequest& request, unsigned int type=HANDLER_PROPERTY_ALL) const;
