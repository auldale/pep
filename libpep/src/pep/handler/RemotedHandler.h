...
namespace pep {
    ...
    protected:
         ...
         */
        DDF wrap(const PEPRequest& request, const std::vector<std::string>* headers=nullptr, bool certs=false) const;
         ...
         */
        virtual std::pair<bool,long> unwrap(PEPRequest& request, DDF& out) const;
