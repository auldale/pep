...
//typedef std::pair<const PropertySet*,void*> Settings;
    typedef std::pair<const PropertySet*,void*> Settings;
     ...
     */
    class PEPRequest : public virtual xmltooling::HTTPRequest, public virtual xmltooling::HTTPResponse
    {
    protected:
    	PEPRequest();
    public:
        ...
        virtual const PEP& getPEP() const=0;
