...
namespace pep {
    ...
    public:
        ...
        const PropertySet* getPropertySet(const char* name, const char* ns=pepconstants::ASCII_SHIB2SPCONFIG_NS) const;
        ...
        // TODO zde byla provedena uprava - setPropery byla presunuta do public scopu, aby nemusela byt vytvarena subclass
//    protected:
        /**
