    ...
    )
{
    ...
    m_root=e;
    if (!log)
        log = &Category::getInstance("PropertySet");
    ...
    for (XMLSize_t i=0; i<attrs->getLength(); i++) {
        ...
        if (val && *val) {
            ...
            // TODO zde to bylo upraveno tak aby to pro handlery fungovalo asi chyba proverit
            auto_ptr_char name(a->getNodeName());
