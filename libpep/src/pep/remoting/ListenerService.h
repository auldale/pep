...
class Remoted {
	...
	Remoted(const Remoted& r);
	Remoted& operator =(const Remoted& r);
 ...
 */
class ListenerService: public virtual Remoted {
protected:
	ListenerService();
public:
...
typedef ListenerService* (*ListenerServiceFactory)(const xercesc::DOMElement* const & elem);
